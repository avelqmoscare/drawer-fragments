...
public class FragmentC extends Fragment implements CompoundButton.OnCheckedChangeListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.toggle_layout, container, false);
